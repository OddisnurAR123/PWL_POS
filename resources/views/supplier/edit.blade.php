            ...
            @else
                <form method="POST" action="{{ url('/supplier/' . $supplier->supplier_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="supplier_notelp">No. Telepon Supplier</label>
                        <input type="text" name="supplier_notelp" id="supplier_notelp" class="form-control" value="{{ old('supplier_notelp', $supplier->supplier_notelp ?? '') }}" maxlength="15">
                    </div>
                    <div class="form-group row">

        ...
        <div class="card-body">
            <form method="POST" action="{{ url('supplier') }}" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="supplier_notlp">No. Telepon Supplier</label>
                    <input type="text" name="supplier_notlp" id="supplier_notlp" class="form-control" value="{{ old('supplier_notelp', $supplier->supplier_notelp ?? '') }}" maxlength="15">
                </div>
                <div class="form-group row">
